...
[The Wasp CLI](https://github.com/wasp-lang/wasp/blob/main/waspc/cli/src/Wasp/Cli/Command/News.hs) then fetches this file and displays the news to the user.
